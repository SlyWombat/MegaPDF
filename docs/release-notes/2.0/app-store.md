# App Store (iPhone and iPad) — "What's New in This Version", 2.0.0

App Store Connect → the 2.0 version page → **Localizations** → *What's New in
...
> are identical here: nothing in this copy is one of the words the derivation
> table changes, and the only punctuation France spaces differently from Quebec
> (`?`, `!`, `;`) does not occur.
