...
public class StringCatalogueTests
{
    ...
    private static readonly Dictionary<string, string> SameInFrench = new()
    {
        ...
        ["ToolbarSignatures"] = "\"Signatures\" is the same word (#144)",
        ...
        ["RedactedImagesOne"] = "\"1 image\" is the same in both (#173)",
        ["RedactedAnnotations"] = "\"{0} annotations\" is the same in both (#173)",
        ["RedactedAnnotationsOne"] = "\"1 annotation\" is the same in both (#173)",
        ["redacted_images"] = "Android: the same word (#173)",
        ["redacted_images_one"] = "Android: the same word (#173)",
        ["redacted_annotations"] = "Android: the same word (#173)",
        ["redacted_annotations_one"] = "Android: the same word (#173)",
        ["{0} images"] = "iOS: the same word (#173)",
        ["1 image"] = "iOS: the same word (#173)",
        ["{0} annotations"] = "iOS: the same word (#173)",
        ["1 annotation"] = "iOS: the same word (#173)",
