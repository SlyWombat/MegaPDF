...
public class UserDataPathsTests : IDisposable
{
    ...
    public void Root_WhenTheDataFolderIsNotThere_CreatesIt()
    {
        ...
        if (OperatingSystem.IsWindows())
            return;   // %LOCALAPPDATA% is always there, and XDG_DATA_HOME means nothing to it
    ...
    [Fact]
    public void Root_WithNoHomeAndNoXdgDataHome_SaysSoRatherThanReturningARelativePath()
    {
        ...
        Assert.Contains("XDG_DATA_HOME", ex.Message);
