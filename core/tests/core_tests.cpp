...
// #151, PDFium patch 0024: an image of 60 MB or more decoded was never kept by PDFium's page
...
void test_huge_image_render_cache() {
    ...
    if (MEGAPDF_PDFIUM_PATCHES >= 24) {
        check(again_ms * 4 < first_ms, "huge image cache: rendering the page again does not decode the image again (patch 0024)",
